...
More examples can be found here: https://code.zmaw.de/projects/cdo/wiki/Ram#ICON-plot.

== Recommendations

Use the provided ncl wrapper script nclsh (see contrib dir, https://github.com/Try2Code/iconPlot/tree/master/contrib) from Karl-Hermann Wieners. This will reduce the quoting to tolerable amount:
...
Requires:: NCL >= 6.x, CDO 1.5.x
License::  Copyright 2011-2013 by Ralf Mueller
           Released under GPLv2 license.  See the LICENSE
