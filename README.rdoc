...
Use the provided ncl wrapper script nclsh (see contrib dir, https://github.com/Try2Code/iconPlot/tree/master/contrib) from Karl-Hermann Wieners. This will reduce the quoting to tolerable size:
